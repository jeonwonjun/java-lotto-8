...
public enum ErrorMessage {
    ...
    INVALID_PURCHASE_AMOUNT_POINT("구입 금액은 1000단위어야 합니다."),
    INVALID_PURCHASE_AMOUNT_MIN("구입 금액은 1000원 이상이어야 합니다.");

    private final String message;
    private static final String EORRO_MESSAGE = "[ERROR] %s";
    ...
    public String getMessage() {
        return String.format(EORRO_MESSAGE, message);
    }
}
